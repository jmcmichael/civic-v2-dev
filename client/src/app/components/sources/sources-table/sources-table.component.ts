...
import { BrowseSourceConnection, BrowseSourceRowFieldsFragment, BrowseSourcesGQL, BrowseSourcesQuery, Maybe, PageInfo, QueryBrowseSourcesArgs, SourceSource, SourcesSortColumns } from "@app/generated/civic.apollo";
...
export class CvcSourcesTableComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.connection$ = this.result$
      .pipe(pluck('data', 'browseSources'),
        filter(isNonNulled)) as Observable<BrowseSourceConnection>;
