...
import { AcceptRevisionsActivityDetailFragmentDoc } from './kinds/accept-revisions/accept-revisions-activity.query.gql.generated';
import { CommentActivityDetailFragmentDoc } from './kinds/comment/comment-activity.query.gql.generated';
import { CreateComplexMolecularProfileActivityDetailFragmentDoc } from './kinds/create-molecular-profile/create-mp-activity.query.gql.generated';
import { CreateVariantActivityDetailFragmentDoc } from './kinds/create-variant/create-variant-activity.query.gql.generated';
import { DeleteCommentActivityDetailFragmentDoc } from './kinds/delete-comment/delete-comment-activity.query.gql.generated';
import { DeprecateComplexMolecularProfileActivityDetailFragmentDoc } from './kinds/deprecate-molecular-profile/deprecate-mp-activity.query.gql.generated';
import { DeprecateVariantActivityDetailFragmentDoc } from './kinds/deprecate-variant/deprecate-variant-activity.query.gql.generated';
import { DeprecateFeatureActivityDetailFragmentDoc } from './kinds/deprecate-feature/deprecate-feature-activity.query.gql.generated';
import { FlagEntityActivityDetailFragmentDoc } from './kinds/flag-entity/flag-entity-activity.query.gql.generated';
import { ModerateAssertionActivityDetailFragmentDoc } from './kinds/moderate-assertion/moderate-assertion-activity.query.gql.generated';
import { ModerateEvidenceItemActivityDetailFragmentDoc } from './kinds/moderate-evidence/moderate-evidence-activity.query.gql.generated';
import { RejectRevisionsActivityDetailFragmentDoc } from './kinds/reject-revisions/reject-revisions-activity.query.gql.generated';
import { ResolveFlagActivityDetailFragmentDoc } from './kinds/resolve-flag/resolve-flag-activity.query.gql.generated';
import { SubmitAssertionActivityDetailFragmentDoc } from './kinds/submit-assertion/submit-assertion-activity.query.gql.generated';
import { SubmitEvidenceItemActivityDetailFragmentDoc } from './kinds/submit-evidence/submit-evidence-activity.query.gql.generated';
import { SuggestRevisionSetActivityDetailFragmentDoc } from './kinds/suggest-revisions/suggest-revisions-activity.query.gql.generated';
import { SuggestSourceActivityDetailFragmentDoc } from './kinds/suggest-source/suggest-source-activity.query.gql.generated';
import { UpdateSourceSuggestionStatusActivityDetailFragmentDoc } from './kinds/update-source-suggestion/update-source-suggestion-activity.query.gql.generated';
import { ApproveAssertionActivityDetailFragmentDoc } from './kinds/approve-assertion/approve-assertion-activity.query.gql.generated';
import { RevokeApprovalActivityDetailFragmentDoc } from './kinds/revoke-approval/revoke-approval-activity.query.gql.generated';
...
export type ActivityFeedItemQuery = { __typename: 'Query', activity?:
    | { __typename: 'AcceptRevisionsActivity', note?: string | undefined, id: number, verbiage: string, createdAt: any, organization?: { __typename: 'Organization', id: number, name: string } | undefined, user: { __typename: 'User', id: number, displayName: string, role: Types.UserRole }, subject:
      ...
      >, revisions: Array<{ __typename: 'Revision', id: number, name: string, status: Types.RevisionStatus, currentValue?: any | undefined, suggestedValue?: any | undefined, fieldName: string, link: string, createdAt: any, linkoutData: { __typename: 'LinkoutData', name: string, diffValue:
         ...
         }>, supersededRevisions: Array<{ __typename: 'Revision', id: number, link: string, name: string, fieldName: string, createdAt: any, creationActivity?: { __typename: 'SuggestRevisionSetActivity', user: { __typename: 'User', displayName: string, id: number, role: Types.UserRole } } | undefined }>, events: Array<{ __typename: 'Event', id: number, createdAt: any, action: Types.EventAction, originatingObject?:
          | { __typename: 'Assertion', id: number, name: string, link: string }
    ...
    | { __typename: 'CommentActivity', note?: string | undefined, id: number, verbiage: string, createdAt: any, comment: { __typename: 'Comment', id: number, name: string, link: string, deleted: boolean, deletedAt?: any | undefined, title?: string | undefined, comment: string, createdAt: any, commentable:
          ...
          | { __typename: 'Variant', id: number, name: string, link: string }
          | { __typename: 'VariantGroup', id: number, name: string, link: string }
        , commenter: { __typename: 'User', id: number, username: string, displayName: string, name?: string | undefined, role: Types.UserRole, profileImagePath?: string | undefined, organizations: Array<{ __typename: 'Organization', id: number, name: string }> }, parsedComment: Array<
          | { __typename: 'CommentTagSegment', entityId: number, displayName: string, tagType: Types.TaggableEntity, link: string, revisionSetId?: number | undefined, feature?: { __typename: 'LinkableFeature', id: number, name: string, link: string, deprecated: boolean, flagged: boolean } | undefined }
          | { __typename: 'CommentTagSegmentDeprecated', entityId: number, displayName: string, tagType: Types.TaggableEntity, deprecated: boolean, link: string, revisionSetId?: number | undefined, feature?: { __typename: 'LinkableFeature', id: number, name: string, link: string, deprecated: boolean, flagged: boolean } | undefined }
          | { __typename: 'CommentTagSegmentFlagged', entityId: number, displayName: string, tagType: Types.TaggableEntity, flagged: boolean, link: string, revisionSetId?: number | undefined, feature?: { __typename: 'LinkableFeature', id: number, name: string, link: string, deprecated: boolean, flagged: boolean } | undefined }
          | { __typename: 'CommentTagSegmentFlaggedAndDeprecated', entityId: number, displayName: string, tagType: Types.TaggableEntity, flagged: boolean, deprecated: boolean, link: string, revisionSetId?: number | undefined, feature?: { __typename: 'LinkableFeature', id: number, name: string, link: string, deprecated: boolean, flagged: boolean } | undefined }
