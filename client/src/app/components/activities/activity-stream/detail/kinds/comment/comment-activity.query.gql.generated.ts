...
export type CommentActivityDetailQueryVariables = Types.Exact<{
  id: Types.Scalars['Int']['input'];
}>;


export type CommentActivityDetailQuery = { __typename: 'Query', activity?:
    | { __typename: 'AcceptRevisionsActivity' }
    | { __typename: 'ApproveAssertionActivity' }
    | { __typename: 'CommentActivity', id: number, verbiage: string, createdAt: any, comment: { __typename: 'Comment', deleted: boolean, deletedAt?: any | undefined, id: number, name: string, link: string, title?: string | undefined, comment: string, createdAt: any, commentable:
...
export const CommentActivityDetailDocument = gql`
    query CommentActivityDetail($id: Int!) {
  activity(id: $id) {
  ...
  export class CommentActivityDetailGQL extends Apollo.Query<CommentActivityDetailQuery, CommentActivityDetailQueryVariables> {
    document = CommentActivityDetailDocument;
