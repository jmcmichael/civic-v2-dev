...
export type RejectRevisionsActivityDetailQueryVariables = Types.Exact<{
  id: Types.Scalars['Int']['input'];
}>;


export type RejectRevisionsActivityDetailQuery = { __typename: 'Query', activity?:
    ...
    | { __typename: 'RejectRevisionsActivity', id: number, verbiage: string, createdAt: any, parsedNote: Array<
...
export const RejectRevisionsActivityDetailDocument = gql`
    query RejectRevisionsActivityDetail($id: Int!) {
  activity(id: $id) {
    ...RejectRevisionsActivityDetail
  }
}
  ...
  export class RejectRevisionsActivityDetailGQL extends Apollo.Query<RejectRevisionsActivityDetailQuery, RejectRevisionsActivityDetailQueryVariables> {
    document = RejectRevisionsActivityDetailDocument;
