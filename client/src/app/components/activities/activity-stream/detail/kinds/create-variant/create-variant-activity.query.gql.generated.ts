...
export type CreateVariantActivityDetailFragment = { __typename: 'CreateVariantActivity', id: number, verbiage: string, createdAt: any, organization?: { __typename: 'Organization', id: number, name: string } | undefined, user: { __typename: 'User', id: number, displayName: string, role: Types.UserRole }, subject:
...
export const CreateVariantActivityDetailFragmentDoc = gql`
    fragment CreateVariantActivityDetail on CreateVariantActivity {
