...
export type DeleteCommentActivityDetailFragment = { __typename: 'DeleteCommentActivity', id: number, verbiage: string, createdAt: any, comment: { __typename: 'Comment', deleted: boolean, deletedAt?: any | undefined, id: number, name: string, link: string, title?: string | undefined, comment: string, createdAt: any, commenter: { __typename: 'User', id: number, username: string, displayName: string, name?: string | undefined, role: Types.UserRole, profileImagePath?: string | undefined, organizations: Array<{ __typename: 'Organization', id: number, name: string }> }, parsedComment: Array<
    ...
    | { __typename: 'VariantGroup', id: number, name: string, link: string }
  , organization?: { __typename: 'Organization', id: number, name: string } | undefined, user: { __typename: 'User', id: number, displayName: string, role: Types.UserRole }, events: Array<{ __typename: 'Event', id: number, createdAt: any, action: Types.EventAction, originatingObject?:
      | { __typename: 'Assertion', id: number, name: string, link: string }
...
export const DeleteCommentActivityDetailFragmentDoc = gql`
