...
export type AdvancedSearchResultKeySpecifier = ('formQuery' | 'normalizedFormQuery' | 'originalQuery' | 'permalinkId' | 'resultIds' | 'searchEndpoint' | AdvancedSearchResultKeySpecifier)[];
export type AdvancedSearchResultFieldPolicy = {
	formQuery?: FieldPolicy<any> | FieldReadFunction<any>,
	normalizedFormQuery?: FieldPolicy<any> | FieldReadFunction<any>,
