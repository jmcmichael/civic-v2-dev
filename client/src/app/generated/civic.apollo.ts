...
export type NullableDrugInteractionTypeInput = {
  ...
  unset?: InputMaybe<Scalars['Boolean']>;
  /** The desired value for the field. Mutually exclusive with unset. */
  value?: InputMaybe<DrugInteraction>;
};
...
export type QueryAssertionsArgs = {
  ...
  before?: InputMaybe<Scalars['String']>;
  clinicalSignificance?: InputMaybe<EvidenceClinicalSignificance>;
...
export type DiseasePopoverQuery = { __typename: 'Query', diseasePopover?: { __typename: 'DiseasePopover', id: number, name: string, displayName: string, doid?: number | undefined, diseaseUrl?: string | undefined, diseaseAliases: Array<string>, assertionCount: number, evidenceItemCount: number, variantCount: number, link: string } | undefined };
...
export type DrugPopoverQuery = { __typename: 'Query', drugPopover?: { __typename: 'DrugPopover', id: number, name: string, drugUrl?: string | undefined, ncitId?: string | undefined, drugAliases: Array<string>, assertionCount: number, evidenceItemCount: number, link: string } | undefined };
...
export type SourcePopoverFragment = { __typename: 'SourcePopover', id: number, name: string, evidenceItemCount: number, citation?: string | undefined, citationId: number, displayType: string, sourceUrl?: string | undefined, clinicalTrials?: Array<{ __typename: 'ClinicalTrial', id: number, nctId: string, link: string }> | undefined };
...
export type DiseaseTypeaheadQuery = { __typename: 'Query', diseaseTypeahead: Array<{ __typename: 'Disease', id: number, name: string, displayName: string, doid?: number | undefined, diseaseAliases: Array<string> }> };
...
export type DrugTypeaheadQuery = { __typename: 'Query', drugTypeahead: Array<{ __typename: 'Drug', id: number, name: string, ncitId?: string | undefined, drugAliases: Array<string> }> };
...
export type AddDrugMutation = { __typename: 'Mutation', addDrug?: { __typename: 'AddDrugPayload', new: boolean, drug: { __typename: 'Drug', id: number, ncitId?: string | undefined, name: string } } | undefined };

export type AddDrugFieldsFragment = { __typename: 'AddDrugPayload', new: boolean, drug: { __typename: 'Drug', id: number, ncitId?: string | undefined, name: string } };
...
export type CitationTypeaheadQuery = { __typename: 'Query', sourceTypeahead: Array<{ __typename: 'Source', id: number, name: string, citation?: string | undefined, citationId: number, sourceType: SourceSource }> };

export type SourceTypeaheadResultFragment = { __typename: 'Source', id: number, name: string, citation?: string | undefined, citationId: number, sourceType: SourceSource };
...
export type SourceTypeaheadQuery = { __typename: 'Query', sourceTypeahead: Array<{ __typename: 'Source', id: number, name: string, citation?: string | undefined, citationId: number, sourceType: SourceSource }> };

export type SourceTypeaheadFieldsFragment = { __typename: 'Source', id: number, name: string, citation?: string | undefined, citationId: number, sourceType: SourceSource };
...
export type GeneRevisableFieldsQuery = { __typename: 'Query', gene?: { __typename: 'Gene', id: number, description: string, sources: Array<{ __typename: 'Source', id: number, sourceType: SourceSource, citation?: string | undefined, citationId: number }> } | undefined };

export type RevisableGeneFieldsFragment = { __typename: 'Gene', id: number, description: string, sources: Array<{ __typename: 'Source', id: number, sourceType: SourceSource, citation?: string | undefined, citationId: number }> };
...
export type RevisableVariantFieldsFragment = { __typename: 'Variant', id: number, name: string, description?: string | undefined, variantAliases: Array<string>, alleleRegistryId?: string | undefined, clinvarIds: Array<string>, ensemblVersion?: number | undefined, hgvsDescriptions: Array<string>, referenceBuild?: ReferenceBuild | undefined, referenceBases?: string | undefined, variantBases?: string | undefined, sources: Array<{ __typename: 'Source', id: number, sourceType: SourceSource, citation?: string | undefined, citationId: number }>, gene: { __typename: 'Gene', id: number, name: string }, variantTypes: Array<{ __typename: 'VariantType', id: number, name: string, soid: string }>, primaryCoordinates?: { __typename: 'Coordinate', chromosome?: string | undefined, representativeTranscript?: string | undefined, start?: number | undefined, stop?: number | undefined } | undefined, secondaryCoordinates?: { __typename: 'Coordinate', chromosome?: string | undefined, representativeTranscript?: string | undefined, start?: number | undefined, stop?: number | undefined } | undefined };
...
export type DiseaseDetailQuery = { __typename: 'Query', disease?: { __typename: 'Disease', id: number, name: string, doid?: number | undefined, diseaseUrl?: string | undefined, displayName: string, diseaseAliases: Array<string>, link: string } | undefined };
...
export type DrugDetailQuery = { __typename: 'Query', drug?: { __typename: 'Drug', id: number, name: string, ncitId?: string | undefined, drugUrl?: string | undefined, drugAliases: Array<string>, link: string } | undefined };
...
export type DrugsSummaryQuery = { __typename: 'Query', drug?: { __typename: 'Drug', id: number, name: string, ncitId?: string | undefined, drugUrl?: string | undefined, drugAliases: Array<string>, link: string } | undefined };

export type DrugsSummaryFieldsFragment = { __typename: 'Drug', id: number, name: string, ncitId?: string | undefined, drugUrl?: string | undefined, drugAliases: Array<string>, link: string };
...
type MolecularProfileParsedName_Variant_Fragment = { __typename: 'Variant', id: number, name: string, link: string };
...
export type SourceDetailQuery = { __typename: 'Query', source?: { __typename: 'Source', id: number, citation?: string | undefined, sourceUrl?: string | undefined, displayType: string, citationId: number } | undefined };

export type SourceDetailFieldsFragment = { __typename: 'Source', id: number, citation?: string | undefined, sourceUrl?: string | undefined, displayType: string, citationId: number };
...
export type VariantDetailQuery = { __typename: 'Query', variant?: { __typename: 'Variant', id: number, name: string, variantAliases: Array<string>, gene: { __typename: 'Gene', id: number, name: string }, flags: { __typename: 'FlagConnection', totalCount: number }, revisions: { __typename: 'RevisionConnection', totalCount: number }, comments: { __typename: 'CommentConnection', totalCount: number } } | undefined };

export type VariantDetailFieldsFragment = { __typename: 'Variant', id: number, name: string, variantAliases: Array<string>, gene: { __typename: 'Gene', id: number, name: string }, flags: { __typename: 'FlagConnection', totalCount: number }, revisions: { __typename: 'RevisionConnection', totalCount: number }, comments: { __typename: 'CommentConnection', totalCount: number } };
