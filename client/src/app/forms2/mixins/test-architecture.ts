...
// BaseList?: FieldType<F extends FormlyFieldConfig = FormlyFieldConfig>
// BaseList: FieldType<FieldTypeConfig<CvcGeneSelectFieldProps>>
// BaseResourceModel: FieldTypeConfig<T extends FormlyFieldProps>
// BaseListComponent: CvcBaseFieldTypeDirective
// ConcreteClass<C>: ConcreteClass<T = {}> = new (...args: any[]) => T
// BaseServerList: CvcGeneSelectField
// TableMixin: BaseFieldTypeMixin
...
export interface IBaseList<T extends BaseResourceModel>
  extends ConcreteClass<BaseListComponent<T>> {}
...
@Component({ template: '' })
export abstract class BaseListComponent<T extends BaseResourceModel>
...
class DummyBaseList<T> extends BaseListComponent<T> {}
