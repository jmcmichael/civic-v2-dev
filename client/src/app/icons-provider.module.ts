...
import {
  ...
  civicGeneOutline,
  civicGeneTwotone,
  // NOTE: Drug and Intervention symbolize the same entity, Intervention will replace Drug
  // in a future version of CIViC's knowledge model. The icon symbol/color are the same.
