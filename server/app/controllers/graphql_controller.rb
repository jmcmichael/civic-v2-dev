class GraphqlController < ApplicationController
  ...
  # approaches this cap.
  #
  # NOTE: this bounds operation COUNT, not cost. The schema sets no
  # max_complexity and no max_depth, so a single expensive query is already
  # unbounded — batching multiplies that rather than causing it. A complexity
  # limit is the real control and wants measuring against real operations
